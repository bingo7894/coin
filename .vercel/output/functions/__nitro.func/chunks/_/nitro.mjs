...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "7b664778-a777-484f-b068-94fa80a1f5bd",
  ...
  "session": {
    "name": "nuxt-session",
    "password": "4715c9c72cdd45a38af928b34950b8dd",
    "cookie": {
      "sameSite": "lax"
    }
  },
...
const _R6gELsdEFvUQGUp6LYFVuyAl4HvdGCku0ttq1DzWI1E = defineNitroPlugin((nitroApp) => {
...
const _tK1mQvswCuysG4pChyk1NRrBkJwbgaA3vQd72PV13A = (function(nitro) {
...
const plugins = [
  _R6gELsdEFvUQGUp6LYFVuyAl4HvdGCku0ttq1DzWI1E,
_tK1mQvswCuysG4pChyk1NRrBkJwbgaA3vQd72PV13A
];
...
const collections = {
  'flat-color-icons': () => import('./icons.mjs').then(m => m.default),
  'lucide': () => import('./icons2.mjs').then(m => m.default),
};

const DEFAULT_ENDPOINT = "https://api.iconify.design";
const _mPyLY7 = defineCachedEventHandler(async (event) => {
...
const _mlgyZ7 = eventHandler(async (event) => {
  await clearUserSession(event);
  return { loggedOut: true };
});

const _JScgGq = eventHandler(async (event) => {
...
const _lazy_ZXAy1w = () => import('../routes/api/account/stats.get.mjs');
const _lazy_qclC2N = () => import('../routes/api/auth/github.mjs');
const _lazy_PnmPnt = () => import('../routes/api/auth/login.post.mjs');
const _lazy_xnQAxJ = () => import('../routes/api/auth/register.post.mjs');
const _lazy_5xiZbu = () => import('../routes/api/history/_id_.get.mjs');
const _lazy_Sgk5ek = () => import('../routes/api/index.get.mjs');
const _lazy_9bGLDT = () => import('../routes/api/index.post.mjs');
const _lazy_LkP1TX = () => import('../routes/api/index.post2.mjs');
const _lazy_zwK0QK = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/account/stats', handler: _lazy_ZXAy1w, lazy: true, middleware: false, method: "get" },
  { route: '/api/auth/github', handler: _lazy_qclC2N, lazy: true, middleware: false, method: undefined },
  { route: '/api/auth/login', handler: _lazy_PnmPnt, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/register', handler: _lazy_xnQAxJ, lazy: true, middleware: false, method: "post" },
  { route: '/api/history/:id', handler: _lazy_5xiZbu, lazy: true, middleware: false, method: "get" },
  { route: '/api/history', handler: _lazy_Sgk5ek, lazy: true, middleware: false, method: "get" },
  { route: '/api/history', handler: _lazy_9bGLDT, lazy: true, middleware: false, method: "post" },
  { route: '/api/report', handler: _lazy_LkP1TX, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_zwK0QK, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _mPyLY7, lazy: false, middleware: false, method: undefined },
  { route: '/api/_auth/session', handler: _mlgyZ7, lazy: false, middleware: false, method: "delete" },
  { route: '/api/_auth/session', handler: _JScgGq, lazy: false, middleware: false, method: "get" },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_zwK0QK, lazy: true, middleware: false, method: undefined }
];
...
export { isScriptProtocol as A, joinURL as B, klona as C, appendResponseHeader as D, withQuery as E, sanitizeStatusCode as F, withTrailingSlash as G, withoutTrailingSlash as H, getContext as I, baseURL as J, createHooks as K, executeAsync as L, withBase as M, destr as N, toRouteMatcher as O, createRouter$1 as P, hash$1 as Q, defineOAuthGitHubEventHandler as a, sanitizeUser as b, createError$1 as c, defineEventHandler as d, setUserSession as e, readBody as f, getUserSession as g, hashPassword as h, buildAssetsURL as i, useRuntimeConfig as j, getResponseStatusText as k, getResponseStatus as l, defineRenderHandler as m, publicAssetsURL as n, getQuery as o, parseQuery as p, getRouteRules as q, readValidatedBody as r, sendRedirect as s, toNodeListener as t, useNitroApp as u, verifyPassword as v, defuFn as w, defu as x, createDefu as y, hasProtocol as z };
